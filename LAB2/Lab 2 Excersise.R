...
facebook_data <- read.csv("C:/Users/tejal/OneDrive/Documents/TY sem 5/R programing/datasets_lab1/dataset_Facebook.csv",sep = ";",
                          header = TRUE, stringsAsFactors = FALSE)
#Load excel file
library(readxl)
lungcap_data <- read_excel("C:/Users/tejal/OneDrive/Documents/TY sem 5/R programing/datasets_lab1/LungCap_Dataset.xls")

#load another file
titanic_data <- read.csv("C:/Users/tejal/OneDrive/Documents/TY sem 5/R programing/datasets_lab1/train_titanic.csv",
                         header = TRUE, stringsAsFactors = FALSE)
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
titanic_df <- read.csv("C:/Users/tejal/OneDrive/Documents/TY sem 5/R programing/datasets_lab1/train_titanic.csv")
str(titanic_df)
#-------------------------------------------------------------------------------
